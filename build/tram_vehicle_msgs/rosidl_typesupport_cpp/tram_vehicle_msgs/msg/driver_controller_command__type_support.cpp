...
static const _DriverControllerCommand_type_support_symbol_names_t _DriverControllerCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tram_vehicle_msgs, msg, DriverControllerCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tram_vehicle_msgs, msg, DriverControllerCommand)),
  }
};
...
{
  return &::tram_vehicle_msgs::msg::rosidl_typesupport_cpp::DriverControllerCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tram_vehicle_msgs, msg, DriverControllerCommand)() {
  return get_message_type_support_handle<tram_vehicle_msgs::msg::DriverControllerCommand>();
}
